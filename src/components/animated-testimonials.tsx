      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <p className="text-sm text-violet-800 dark:text-neutral-500">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-7 w-7 rounded-full bg-purple-500 dark:bg-neutral-800 flex items-center justify-center group/button"
            >
