const TextRevealButton = () => {
    return (
      <button className="group/button relative inline-flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-violet-600 font-bold text-white transition-all duration-300 hover:w-48 ">
