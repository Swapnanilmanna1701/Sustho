    ...
    <section className="py-10 bg-black w-full">
      <div className="flex flex-col items-center bg-black justify-center">
        <div className="mb-6 flex size-10 items-center justify-center rounded-lg border-2 border-black/5 bg-black/5 dark:bg-white/5">
          <Zap aria-hidden="true" className="animate-bounce size-10 text-purple-600" />
        </div>
      ...
      <div className="mx-auto text-violet-500 mt-10 block max-w-3xl justify-between gap-14 space-y-6 md:mt-14 md:flex md:space-y-0">
        {stats.map((stat, index) => (
          <div key={index} className="flex items-center gap-5">
            <div className="h-28 w-0.5 bg-gradient-to-b from-transparent via-purple-600 to-transparent" />
            <div>
              <div className="text-3xl">
                <NumberTicker value={stat.percentage} className="text-white" />%
              </div>
