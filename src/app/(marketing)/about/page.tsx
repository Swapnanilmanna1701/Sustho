  ...
  return (
    <section className="relative overflow-hidden  py-20">
      <Particles
        ...
        refresh
      />
      <div className="absolute left-1/2 top-1/2 -z-50 h-32 w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-3xl bg-gradient-to-br from-violet-600 to-purple-600 opacity-50 blur-[200px]" />
      <div className="flex flex-col items-center justify-center">
        <h1 className="text-balance text-center text-4xl font-semibold leading-normal lg:max-w-3xl lg:text-5xl">
          Wants to build{" "}
